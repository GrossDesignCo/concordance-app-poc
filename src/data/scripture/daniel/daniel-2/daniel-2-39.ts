...
export const daniel_2_39: Verse = {
  meta: {
    book: 'Daniel',
    chapter: 2,
    verse: 39,
  ...
  words: [
    {
      aramaic: 'וּבָתְרָךְ',
      transliteration: 'uVathrakh',
      englishLiteral: 'and-after-you',
      englishNatural: 'And after you',
      root: 'achar',
      prefixes: ['u'],
      suffixes: ['akh'],
      order: 1,
    ...
    {
      aramaic: 'מִנָּךְ',
      transliteration: 'minnakh',
      englishLiteral: 'from-you',
      englishNatural: 'than you',
      root: 'min',
      suffixes: ['akh'],
      order: 6,
      morphology: {
    ...
    {
      aramaic: 'תִשְׁלַט',
      transliteration: 'tishlat',
      englishLiteral: 'will-rule',

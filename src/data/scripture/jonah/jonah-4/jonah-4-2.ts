...
export const jonah_4_2: Verse = {
  ...
  expectedTranslations: {
    ...
    englishLiteral:
      'And-prayed to- He_Who_Is (YHWH) and-said, "please He_Who_Is (YHWH), is-not- this word-my unto- being-my over- earth-my? over- so I-preceded to-flee golden_stone (Tarshish), that I-knew that- you God- gracious and-compassionate, long nostrils and-great- steadfast_love and-comforting over- the-bad.',
    englishNatural:
      'And he prayed to He-Who-Is (YHWH) and said, "Please He-Who-Is (YHWH), was not this my word unto I was over my earth? So moreover I preceded to flee to golden-stone (Tarshish), that I knew that you are God gracious and compassionate, long of nostrils and great of steadfast-love and comforting over the bad.',

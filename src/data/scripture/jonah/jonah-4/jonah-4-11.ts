...
export const jonah_4_11: Verse = {
  ...
  words: [
    ...
    {
      hebrew: 'אָחוּס',
      transliteration: 'achus',
      englishLiteral: 'I-will-pity',
      englishNatural: 'will I pity',
      root: 'chas',
      order: {
        hebrew: 3,
        english: 2,
    ...
    {
      hebrew: 'לִשְׂמֹאלוֹ',
      transliteration: 'lismolo',
      englishLiteral: 'to-left_hand-his',
      englishNatural: 'to his left-hand',
      root: 'smol',
      prefixes: ['li'],
      suffixes: ['o'],
      order: 21,
    ...
    {
      hebrew: 'וּבְהֵמָה',
      transliteration: 'uvehemah',
      englishLiteral: 'and-beast',

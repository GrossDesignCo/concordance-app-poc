...
export const jonah_1_17: Verse = {
  ...
  words: [
    ...
    },
    {
      ...
      englishLiteral: 'in-bowels-of',
      englishNatural: 'in the bowels of',
      root: 'meah_bowels',
      prefixes: ['bi'],
      suffixes: ['ey'],
      order: {
    ...
    {
      hebrew: 'לֵילוֹת',
      transliteration: 'leilot',
      englishLiteral: 'nights',

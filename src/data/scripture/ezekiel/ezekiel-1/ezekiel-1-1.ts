...
export const ezekiel_1_1: Verse = {
  meta: {
    book: 'Ezekiel',
    chapter: 1,
    verse: 1,
  ...
  words: [
    ...
    {
      hebrew: 'בִּשְׁלֹשִׁים',
      transliteration: 'biShloshim',
      englishLiteral: 'in-thirty',

...
export const genesis_4_9: Verse = {
  meta: {
    book: 'Genesis',
    chapter: 4,
    verse: 9,
  ...
  words: [
    ...
    {
      hebrew: 'הֲשֹׁמֵר',
      transliteration: 'haShomer',
      englishLiteral: 'keeper-of',
      englishNatural: 'keeper of',
      root: 'shamar',
      prefixes: ['ha'],
      order: {
        hebrew: 11,
    ...
    },
    {
      ...
      englishLiteral: 'my-brother',
      englishNatural: 'my brother',
      root: 'ach',
      suffixes: ['i'],
      order: {
        hebrew: 12,

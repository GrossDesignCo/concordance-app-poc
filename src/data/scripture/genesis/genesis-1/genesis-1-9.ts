...
export const genesis_1_9: Verse = {
  meta: {
    chapter: 1,
    number: 9,
  },
  words: [
    ...
    {
      hebrew: 'הַיַּבָּשָׁ֑ה',
      transliteration: 'haYabashah',
      englishLiteral: 'the-dry_ground',
      englishNatural: 'And let the dry-ground',
      root: 'yabashah',
      prefixes: ['ha'],
      order: {
        hebrew: 11,

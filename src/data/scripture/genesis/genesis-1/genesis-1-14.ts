...
export const genesis_1_14: Verse = {
  ...
  words: [
    ...
    },
    {
      ...
      englishLiteral: 'for-signs',
      englishNatural: 'for signs',
      root: 'ot',
      prefixes: ['le'],
      suffixes: ['ot'],
      order: {
    ...
    {
      hebrew: 'וּלְמוֹעֲדִ֖ים',
      transliteration: 'uLeMoedim',
      englishLiteral: 'and-for-appointed_times',
      englishNatural: 'and for appointed times',
      root: 'moed',
      prefixes: ['u', 'le'],
      suffixes: ['im'],
      order: {
    ...
    },
    {
      ...
      englishLiteral: 'and-for-days',
      englishNatural: 'and for days',
      root: 'yom',
      prefixes: ['u', 'le'],
      suffixes: ['im'],
      order: {
    ...
    },
    {
      ...
      englishLiteral: 'and-years',
      englishNatural: 'and years',
      root: 'shanah',
      prefixes: ['ve'],
      suffixes: ['im'],
      order: {
  ...
  expectedTranslations: {
    ...
    englishLiteral: 'And-said Gods, "Let-be lights in-hammered_out_work, the-skies, to-separate between the-day, and-between the-night, And-they-will-be for-signs, and-for-appointed_times, and-for-days, and-years.',
    englishNatural: 'And God said, "Let there be lights in the hammered-out-work, the skies, to separate between the day, and between the night, And they will be for signs, and for appointed times, and for days, and years.',

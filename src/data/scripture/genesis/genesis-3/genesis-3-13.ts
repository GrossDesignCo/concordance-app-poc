...
export const genesis_3_13: Verse = {
  meta: {
    book: 'Genesis',
    chapter: 3,
    verse: 13,
  ...
  words: [
    ...
    {
      hebrew: 'לָאִשָּׁה',
      transliteration: 'laIshah',
      englishLiteral: 'to-the-woman',
      englishNatural: 'to the woman',
      root: 'ishah',
      prefixes: ['la'],
      suffixes: ['ah'],
      order: {
    ...
    {
      hebrew: 'הִשִּׁיאַנִי',
      transliteration: 'hishiani',
      englishLiteral: 'he-deceived-me',
      englishNatural: 'he deceived me',
      root: 'nasha',
      prefixes: ['hi'],
      suffixes: ['ani'],
      order: {

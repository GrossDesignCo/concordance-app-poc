...
export const genesis_5_29: Verse = {
  meta: {
    book: 'Genesis',
    chapter: 5,
    verse: 29,
  ...
  words: [
    ...
    {
      hebrew: 'יְנַחֲמֵנוּ',
      transliteration: 'yeNachamenu',
      englishLiteral: 'will-comfort-us',
      englishNatural: 'will comfort us',
      root: 'nacham',
      prefixes: ['ye'],
      suffixes: ['nu'],
      order: {
    ...
    {
      hebrew: 'מִמַּעֲשֵׂנוּ',
      transliteration: 'miMaasenu',
      englishLiteral: 'from-our-making',
      englishNatural: 'from our making',
      root: 'asah',
      prefixes: ['mi', 'ma'],
      suffixes: ['enu'],
      order: {
    ...
    {
      hebrew: 'וּמֵעִצְּבוֹן',
      transliteration: 'uMeItzvon',
      englishLiteral: 'and-from-pain',
    ...
    {
      hebrew: 'יָדֵינוּ',
      transliteration: 'yadenu',
      englishLiteral: 'our-hands',
    ...
    {
      hebrew: 'אֵרְרָהּ',
      transliteration: 'errah',
      englishLiteral: 'he-cursed',
  ...
  expectedTranslations: {
    ...
    englishLiteral:
      'And-called_out ↳ his-name "Rest (Noah)," to-say, "This will-comfort-us from-our-making and-from-pain our-hands, from the-soil which he-cursed He-Who-Is."',
    englishNatural:
      'And he called-out his name "Rest (Noah)," to say, "This will comfort us from our making and from the pain of our hands, from the soil which He-Who-Is cursed."',

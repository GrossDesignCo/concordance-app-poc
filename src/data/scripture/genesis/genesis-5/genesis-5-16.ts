...
export const genesis_5_16: Verse = {
  meta: {
    book: 'Genesis',
    chapter: 5,
    verse: 16,
  ...
  expectedTranslations: {
    hebrew:
      'וַיְחִי מַהֲלַלְאֵל אַחֲרֵי הוֹלִידוֹ אֶת־יָרֶד שְׁלֹשִׁים שָׁנָה וּשְׁמֹנֶה מֵאוֹת שָׁנָה וַיּוֹלֶד בָּנִים וּבָנוֹת',
    transliteration:
      'vaYechi Mahalalel acharey holido et-Yared shloshim shanah uShmoneh meot shanah vaYoled banim uVanot',
    englishLiteral:
      'and-lived Praise_of_God (Mahalaleel) after his-birthing ↳ Descending (Jared), thirty year and-eight hundreds year, and-he-birthed sons and-daughters.',
    englishNatural:
      'And Praise-of-God (Mahalaleel) lived after he birthed Descending (Jared), thirty years and eight hundred years, and birthed sons and daughters.',

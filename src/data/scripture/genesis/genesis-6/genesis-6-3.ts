...
export const genesis_6_3: Verse = {
  meta: {
    book: 'Genesis',
    chapter: 6,
    verse: 3,
  ...
  words: [
    ...
    },
    {
      ...
      englishLiteral: 'my-wind',
      englishNatural: 'My Wind',
      root: 'ruach',
      suffixes: ['i'],
      order: {
        hebrew: 5,
    ...
    },
    {
      ...
      englishLiteral: 'in-the-human',
      englishNatural: 'in the human',
      root: 'adam',
      prefixes: ['ba'],
      order: {
        hebrew: 6,
    ...
    {
      hebrew: 'בְּשַׁגַּם',
      transliteration: 'beShagam',
      englishLiteral: 'in-moreover',
    ...
    {
      hebrew: 'יָמָיו',
      transliteration: 'yamav',
      englishLiteral: 'his-days',
      englishNatural: 'and his days',
      root: 'yom',
      suffixes: ['av'],
      order: {
        hebrew: 12,
  ...
  expectedTranslations: {
    ...
    englishLiteral:
      'And-he-said He_Who_Is, "not- will-judge my-wind in-the-human to-the_age, in-moreover he flesh; and-they-will-be his-days hundred and-twenty year."',
    englishNatural:
      'And He-Who-Is said, "My Wind will judge not in the human to the-age, in moreover he is flesh; and his days will be a hundred and twenty years."',

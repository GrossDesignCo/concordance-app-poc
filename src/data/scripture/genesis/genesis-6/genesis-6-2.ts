...
export const genesis_6_2: Verse = {
  meta: {
    book: 'Genesis',
    chapter: 6,
    verse: 2,
  ...
  words: [
    {
      hebrew: 'וַיִּרְאוּ',
      transliteration: 'vayYiru',
      englishLiteral: 'And-they-saw',
      englishNatural: 'saw',
      root: 'raah',
      prefixes: ['va'],
      order: {
    ...
    {
      hebrew: 'וַיִּקְחוּ',
      transliteration: 'vayYiqchu',
      englishLiteral: 'and-they-took',
  ...
  expectedTranslations: {
    ...
    transliteration:
      'vayYiru beney-haElohim et-benot haAdam ki tovot henah vayYiqchu lahem nashim mikol asher bacharu',
    englishLiteral:
      'And-they-saw sons- the-Gods ↳ daughters-of the-Earth (Adam), that good they; and-they-took to-them women, from-all which they-chose.',
    englishNatural:

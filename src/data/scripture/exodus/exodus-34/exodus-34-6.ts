...
export const exodus_34_6: Verse = {
  meta: {
    book: 'Exodus',
    chapter: 34,
    verse: 6,
  ...
  words: [
    {
      hebrew: 'וַיַּעֲבֹר',
      transliteration: 'vaYaavor',
      englishLiteral: 'And-passed-through',
      englishNatural: 'passed through',
      root: 'avar',
      prefixes: ['va'],
      order: {
        hebrew: 1,
    ...
    {
      hebrew: 'וְחַנּוּן',
      transliteration: 'veChannun',
      englishLiteral: 'and-gracious',

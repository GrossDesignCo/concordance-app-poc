...
const ROOTS = {
  ...
  Yeshua: {
    ...
    englishLiteral: 'He־is_Salvation',
  ...
  torah: {
    ...
    englishNatural: 'law',
    type: 'noun',
    description: 'instruction, teaching, law, direction, later translated "nomos/law" & picked up by the Apostles',
  },
  chafetz: {
    hebrew: 'חֵפֶץ',
    ...
    type: 'noun',
    description: 'a wilful decision to take delight in something, pleasure, desire, will',
  },
  hagah: {
    hebrew: 'הָגָה',
  ...
  peleg: {
    ...
    type: 'noun',
    description: 'stream, channel, division of water, like division in Genesis of the world into continents, or irrigation canals',
  },
  et_time: {
    hebrew: 'עֵת',
    transliteration: 'et',
  ...
  pala: {
    ...
    type: 'verb',
    description: 'to be wonderful, marvelous, extraordinary, beyond understanding',
  },
  levav: {
    hebrew: 'לֵבָב',
  ...
  shavah: {
    ...
    type: 'verb',
    description: 'to equalize, level out, be equal, like; to make level, smooth, calm',
  },
  damam: {
    hebrew: 'דָּמַם',
  ...
  halo: {
    ...
    englishLiteral: 'is there_not',
    englishNatural: 'is there not',
    type: 'adverb',
    description: 'interrogative particle: is there not?, surely?',
  },
  yatav: {
    hebrew: 'יָטַב',
  ...
  charah: {
    ...
    type: 'verb',
    description: 'to fume/seethe with anger, burn with anger, be kindled, be angry',
  },
  napal: {
    hebrew: 'נָפַל',

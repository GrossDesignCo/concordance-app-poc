...
1. Preserve as much as possible the original Hebrew and Greek wordplays/phrasing to best capture connections between concepts, again **from usage** rather than from commentary. (eg. "nachash nashach" → "snake strike", preserving the similar sounding words)
